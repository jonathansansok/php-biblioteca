...
<head>
    ...
    <title>Sistema de biblioteca | Fuente Web</title>
...
<body class="sb-nav-fixed">
    <nav class="sb-topnav navbar navbar-expand navbar-dark bg-primary">
        <a class="navbar-brand" href="<?php echo base_url(); ?>admin/listar">Biblioteca | Fuente Web</a>
        ...
        <div id="layoutSidenav_nav">
            <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                ...
                <div class="sb-sidenav-footer bg-primary">
                    <center>
                    <div class="small"> Visítanos en: </div>
                    <a href="https://www.youtube.com/channel/UCQt66csrx8LcVsI66hnu2fQ" class="text-white"><i class="fab fa-youtube"></i> Fuente Web</a><!--class="text-danger"-->
                    </center>
